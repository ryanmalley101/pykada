...
@typechecked
def get_all_access_users(user_id: Optional[str] = None,
                         external_id: Optional[str] = None) -> dict:
    """
    Retrieve all access users filtered by either user_id or external_id.
    ...
    return get_request(ACCESS_ALL_USERS_ENDPOINT, params=params)
...
def get_profile_photo(user_id: Optional[str] = None,
                      external_id: Optional[str] = None,
                      original: Optional[bool] = False) -> dict:
    """
