...
from endpoints import HELIX_EVENT_TYPE_ENDPOINT, HELIX_EVENT_ENDPOINT, \
    HELIX_SEARCH_ENDPOINT
from verkada_requests import *


# ---------------------------
# Helix Event Type CRUD
# ---------------------------

@typechecked
def create_helix_event_type(event_schema: Dict[str, str], name: str) -> Dict[
    str, Any]:
    """
    ...
    return post_request(HELIX_EVENT_TYPE_ENDPOINT, payload=payload)
...
def get_helix_event_types(
    ...
    return get_request(HELIX_EVENT_TYPE_ENDPOINT, params=params)


@typechecked
def update_helix_event_type(event_type_uid: str, event_schema: Dict[str, str],
...
@typechecked
def delete_helix_event_type(event_type_uid: str) -> Dict[str, Any]:
    """
    ...
    require_non_empty_str(event_type_uid, "event_type_uid")
    params = {"event_type_uid": event_type_uid}
    return delete_request(HELIX_EVENT_TYPE_ENDPOINT, params=params)
...
def create_helix_event(
    ...
    return post_request(HELIX_EVENT_ENDPOINT, payload=payload)


@typechecked
def get_helix_event(camera_id: str, time_ms: int, event_type_uid: str) -> Dict[
    str, Any]:
    """
    ...
    return get_request(HELIX_EVENT_ENDPOINT, params=params)
...
Dict[str, Any]:
    ...
    params = {"camera_id": camera_id, "time_ms": time_ms,
              "event_type_uid": event_type_uid}
    return delete_request(HELIX_EVENT_ENDPOINT, params=params)
...
def search_helix_events(
    ...
    return post_request(HELIX_SEARCH_ENDPOINT, payload=payload)
