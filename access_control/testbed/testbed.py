...
from access_control.access_credentials import add_card_to_user, \
...
from access_control.access_door_exceptions import \
...
from access_control.access_doors import get_doors
from access_control.access_groups import create_access_group, \
    add_user_to_access_group, get_access_groups, get_access_group, \
    delete_access_group
from access_control.access_levels import create_access_level, \
...
from access_control.access_users import get_access_users_information, \
...
from core_command.core_command import create_user, delete_user
from helpers import generate_random_alphanumeric_string, \
...
def access_control_test():
    """
    Test function to create and modify access users
    """
    ...
    all_access_user_info = get_access_users_information()["access_members"]
